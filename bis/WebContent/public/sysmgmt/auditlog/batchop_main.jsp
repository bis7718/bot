...
<div align="left">
	<form action="/nova/sysmgmt/auditlog/batchquery.action" method="post" target="_blank">
		<h2>線上查詢:</h2>
	...
	<form id="dep_f" method="post" action="/nova/sysmgmt/auditlog/batchdownload.action">
		<h2>匯出EXCEL:</h2>
