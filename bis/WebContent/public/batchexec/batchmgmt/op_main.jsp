<%@page pageEncoding="UTF-8"%>
	...
	<form action="batchrun" method="post" onsubmit="run_submit(); return false">
		<h2>一般批次</h2>
			資料日期 (YYYYMMDD)：
		<input type="text" id="dataDate" />
		<input name="commit" onclick="return confirm('確定申請一般批次')" type="submit" value="送出">
	...
	<br>
	<form action="batchrerun" method="post" onsubmit="rerun_submit(); return false">
		<h2>重跑批次</h2>
			年份：
    ...
    <div id="loading_gif1" style="display: none; text-align:left">
		<img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...
	</div>
  </form>
  <br>
  
  <form action="createcsv" method="post" onsubmit="csv_submit(); return false">
		<h2>產生CSV檔案</h2>
			年份：
    ...
    <div id="loading_gif2" style="display: none; text-align:left"><img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...</div>
  </form>
  <br>
  <form action="fixversion" method="post" onsubmit="fixver_submit(); return false">
		<h2>定版</h2>
			年份：
    ...
    <div id="loading_gif3" style="display: none; text-align:left"><img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...</div>
  </form>
  <br>
  <form action="deleteversion" method="post" onsubmit="deleteold_submit(); return false">
		<h2>刪除舊資料</h2>
			年份：
  ...
  <input name="commit" onclick="return confirm('確定申請刪除')" type="submit" value="送出">
    <div id="loading_gif4" style="display: none; text-align:left"><img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...</div>
  </form>
  <p>
		<input checked="checked" id="del_src_ver" type="checkbox" value="1"> 同時刪除來源檔與版本資訊
  </p>
  <br>
  <form action="delete13M" method="post" onsubmit="deleteold13M_submit(); return false">
		<h2>刪除13個月前舊資料</h2>
			年份：
  ...
  <input name="commit" onclick="return confirm('確定申請刪除')" type="submit" value="送出">
    <div id="loading_gif5" style="display: none; text-align:left"><img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...</div>
  </form>
  <br>
  <form action="encrypt" method="post" onsubmit="encrypt_submit(); return false">
		<h2>資料遮蔽</h2>
			年份：
  ...
  <input name="commit" onclick="return confirm('確定申請遮蔽')" type="submit" value="送出">
    <div id="loading_gif6" style="display: none; text-align:left"><img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...</div>
  </form>
  <p>
		<input checked="checked" id="regen_random" type="checkbox" value="1"> 是否重新產生亂數值
  </p>
  <br>
  <form action="transfer" method="post" onsubmit="transfer_submit(); return false">
		<h2>將來源檔案搬至UAT環境</h2>
			年份：
  ...
  <input name="commit" onclick="return confirm('確定申請搬移')" type="submit" value="送出">
    <div id="loading_gif7" style="display: none; text-align:left"><img alt="Loading_s" src="/bis/images/loading_s.gif"> 處理中...</div>
  </form>
  </div>
	</div>