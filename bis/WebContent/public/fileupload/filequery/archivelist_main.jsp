        ...
        <s:iterator value="fileInfoList" status="status">
		  ...
		  <td>
		    <s:url var="copyfile" action="copyfile" escapeAmp="false">
		      <s:param name="type">archive</s:param>
		  ...
		  <td>
		    <s:url var="copyfile" action="copyfile" escapeAmp="false">
		      <s:param name="type">archive</s:param>
			  <s:param name="targetType">input</s:param>
			  <s:param name="filename"><s:property value="fileName" /></s:param>
			  <s:param name="sessionIdSelect"><s:property value="sessionIdSelect" /></s:param>
			</s:url>
		    <a href='<s:property value="#copyfile" />' onclick="return confirm('確定複製檔案<s:property value="fileName" />到input資料夾');">複製</a>
		  </td>
